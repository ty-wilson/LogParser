            ...
            VStack(alignment: .leading) {
                HStack {
                    ...
                    Button("Open in Terminal", action: {
                        let appleScript1 = "tell app \"Terminal\" to do script \"nano +\(self.selectedLineNum! + 1) '\(self.fileHandler.getFilePath())'\""
                    ...
                    Button("Copy to clipboard", action: {
                        ...
                        var stringToCopy = FileHandler.dateToLongTextFormatter.string(from: self.log.dateAtLine[self.selectedLineNum!]!!) + " "
